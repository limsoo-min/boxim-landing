        ...
        >
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <IntroPopup
              title={
                <>
                  최신 스마트폰 & 가성비
                  <br />
                  모두 챙겨야 하는 20대 대학생 A님
                </>
              }
              content={
                <>
                  "민트급 자급제폰을 할인된 가격으로 구매하고, 추천해준 저렴한
                  유심 요금제 가입으로 기존의 2년 약정으로 구매했을 때 보다 훨씬
                  더 저렴하게 스마트폰을 구매했어요."
                </>
              }
              url={"./intro-1.jpeg"}
            ...
            <IntroPopup
              ...
              content={
                <>
                  "부모님께서는 이동통신사를 직접 방문하거나 복잡한 절차를
                  따라야 하는 불편함 없이, 제가 대신 모든 과정을 처리해드리니
                  정말 편리하셨어요. 온라인에서 간단하게 구매하고, 개통까지
                  문제없이 진행되니까 시간도 절약되고 부모님도 최신 기능을 바로
                  경험하실 수 있었습니다."
                </>
              }
              url={"./intro-2.jpeg"}
            ...
            <IntroPopup
              ...
              content={
                <>
                  "제 아이의 첫 스마트폰을 구매하면서, 평소에 바쁜 일정 때문에
                  직접 여러 통신사를 방문하거나 복잡한 절차를 거치기 어려웠는데,
                  스마트폰 구매부터 저렴한 요금제 및 결합을 통한 추가 할인 등
                  모든 과정을 온라인에서 간편하게 한 번에 처리하여 시간과 저희
                  가족 통신비용을 크게 절약 할 수 있었습니다."
                </>
              }
              url={"./intro-3.jpeg"}
            />
        ...
        >
          ...
          <div className="flex flex-col gap-6 lg:gap-8">
            <motion.div
              ...
              transition={{ duration: 0.5, ease: "easeInOut" }}
            >
              <div className="flex-none flex items-center justify-center w-20 lg:w-32 h-20 lg:h-32 rounded-full bg-blue-100 border-[8px] border-white z-3">
                <img
                  src="./concept-1.png"
                  className="w-8 lg:w-16"
                  alt="concept-purchase"
                />
              </div>
              <div className="flex-none flex items-center justify-center w-36 sm:w-48 md:w-56 lg:w-64 h-16 lg:h-24 rounded-full bg-blue-100 -ml-4 lg:-ml-12 z-2 text-[14px] md:text-[16px] lg:text-[18px] font-bold text-center">
                구매 / 가입 따로
              </div>
              <div className="flex-1 flex items-center justify-center w-64 h-16 lg:h-24 rounded-full bg-white px-4 lg:px-12 -ml-4 lg:-ml-12 z-1 text-[14px] md:text-[16px] lg:text-[18px]  text-center">
                단말기와 통신상품은
                <br />
                각각 진행하는게 더 유리
              </div>
            ...
            >
              ...
              <div className="flex-1 flex flex-col items-center justify-center w-64 h-16 lg:h-24 rounded-full bg-white px-4 lg:px-12 -ml-4 lg:-ml-12 z-1 text-[14px] md:text-[16px] lg:text-[18px] text-center">
                박스폰 / 중고폰 구매로 가성비 업
                <Text.Body3>
                  박스폰: 박스 봉일씰이 훼손된 미개통 자급제폰(진열상품 등)
                </Text.Body3>
              </div>
            </motion.div>
            <motion.div
          ...
          <div className="w-full h-120 relative">
            ...
            >
              <div className="lg:flex-1 flex flex-col justify-center items-center gap-2 lg:gap-3 p-12 ">
                ...
                <Text.Header6 className="font-normal text-center">
            ...
            >
              <div className="flex-1 flex flex-col justify-center gap-2 lg:gap-3 p-6 lg:p-12 ">
                <Text.Header3>왜 그럴까요?</Text.Header3>
                <Text.Header6 className="font-normal">
                  <p>
                    현재 통신 시장은 너무나도 복잡합니다. 수많은 유통 구조와
                    복잡한 요금제, 그리고 신뢰하기 어려운 판매처들. 소비자
                    입장에선 선뜻 구매 결정을 내리기가 쉽지 않죠. 이런 고민을
                    하다 보면 결국 ‘모르겠다. 그냥 대리점 가야겠다.’는 결론에
                    도달하곤 합니다.
                  </p>
                </Text.Header6>
              </div>
              <div
                ...
                className="flex-2 h-full bg-no-repeat bg-contain bg-bottom"
              />
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col xl:flex-row gap-6">
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                <Text.Header4>중간 유통구조 생략</Text.Header4>
                <Text.Header6 className="font-normal">
            ...
            >
              ...
              />
              <div className="flex flex-col gap-2">
                <Text.Header4>각기 다른 시장에서 쌓은 전문성</Text.Header4>
                <Text.Header6 className="font-normal">
                  {` `}서로 완전히 다른 단말기 유통시장과 통신사 요금제 약정
                  시장에서 직접 발로 뛰며 구축한 인프라로 자급제 구매부터 요금제
                  개통까지 한번에 해결해드립니다
                </Text.Header6>
              </div>
            </motion.div>
            ...
            >
              ...
              />
              <div className="flex flex-col gap-2">
                <Text.Header4>지원금 가장 많은 요금제 추천</Text.Header4>
                <Text.Header6 className="font-normal">
